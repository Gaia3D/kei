...
import kei.domain.extrusionmodel.DesignLayer;
import kei.domain.extrusionmodel.DesignLayerFileInfo;
import kei.domain.policy.GeoPolicy;
import kei.domain.policy.Policy;
import kei.domain.user.UserSession;
import kei.geospatial.ShapeFileParser;
import kei.service.DesignLayerFileInfoService;
...
import kei.support.ZipSupport;
import kei.utils.FileUtils;
import kei.utils.WebUtils;
...
//			}
			...
			if(DesignLayer.DesignLayerType.LAND == DesignLayer.DesignLayerType.valueOf(designLayer.getDesignLayerGroupType().toUpperCase())) {
				...
				extrusionColumns = geoPolicy.getShapeLineRequiredColumns();
			}
