...
import kei.domain.Depth;
import kei.domain.Move;
import kei.domain.user.UserGroup;
import kei.domain.user.UserGroupMenu;
import kei.domain.user.UserGroupRole;
import kei.domain.YOrN;
import kei.persistence.UserGroupMapper;
import kei.service.UserGroupService;
...
public class UserGroupServiceImpl implements UserGroupService {
	...
	/**
	 * 사용자 그룹 Micro Service 목록
	 * @param userGroupMicroService
	 * @return
	 */
	@Transactional(readOnly=true)
	public List<UserGroupMicroService> getListUserGroupMicroService(UserGroupMicroService userGroupMicroService) {
		return userGroupMapper.getListUserGroupMicroService(userGroupMicroService);
	}
