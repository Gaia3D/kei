...
@Data
@Configuration
@PropertySource("classpath:kei.properties")
@ConfigurationProperties(prefix = "kei")
public class PropertiesConfig {
    ...
    // extrusion model 시뮬레이션 Line shape 파일 테이블 이름. design_layer_line
    private String designLayerLineTable;
}
