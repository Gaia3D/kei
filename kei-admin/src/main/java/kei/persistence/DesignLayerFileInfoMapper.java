...
public interface DesignLayerFileInfoMapper {
	 ...
	 * @return
	 */
	int updateLinePreDataDisable(Long designLayerId);
	...
	/**
	 * line 테이블 데이터 version 갱신
	 * @param fileVersion
	 * @return
	 */
	int updateLineDataFileVersion(Integer fileVersion);
	 ...
	 * @return
	 */
	int updateLineStatus(Integer fileVersion);
