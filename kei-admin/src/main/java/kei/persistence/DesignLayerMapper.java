...
public interface DesignLayerMapper {
    ...
    */
    ...
    /**
     * design Layer line extent 취득
     * @param designLayerId
     * @return
     */
    String getDesignLayerLineExtent(Long designLayerId);
    ...
    */
    ...
    /**
     * building info insert
     * @param designLayerLine
     * @return
     */
    int insertGeometryLine(DesignLayerLine designLayerLine);
    ...
    */
    ...
    /**
     * design layer line 속성 정보 업데이트
     * @param designLayerLine
     * @return
     */
    int updateDesignLayerLineAttributes(DesignLayerLine designLayerLine);
    ...
    */
     ...
     * @return
     */
    int deleteGeometryLine(Map<String,Object> map);
