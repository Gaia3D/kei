...
class PasswordTest {
	...
	void bCryptPasswordEncoderTest() throws Exception {
		...
		String encodePassword = bCryptPasswordEncoder.encode("kei");
		log.info("encodePassword = {}", encodePassword);
		assertEquals(bCryptPasswordEncoder.matches("kei", "$2a$10$2mCd67fsbjmCukpaBlbcau7pjqGqqOeVG6HPiw/jUVWOs//CkcGsq"), true);
	}
}
