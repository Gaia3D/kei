...
public class KeyManagerTest {
	...
	public void keyTest() throws Exception {
		...
		String encryptKey = "aWVrJCNAISBzaSBlbWFuIHltIC5pZWsjQCEgcm9mIGFlZGkgZGFiIGEgZWthbSB0b24gb2QgZXNhZWxwICx5ZWsgdGVyY3MjIGRudW9mIGV2YWggdW95IGZJ";
	...
	public void 키_암호화() throws Exception {
		String key = "If you have found #scret key, please do not make a bad idea for !@#kei. my name is !@#$kei";
