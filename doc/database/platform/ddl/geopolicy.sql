...
create table geopolicy(
    ...
    shape_line_required_columns                         varchar(1000)       default 'id,the_geom',
...
comment on column geopolicy.shape_line_required_columns is '디자인 레이어 line 타입 shape 가시화를 위한 필수 속성명. 콤마로 구분';
