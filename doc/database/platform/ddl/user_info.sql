...
drop table if exists user_group_micro_service cascade;
...
create table user_group_micro_service (
	user_group_micro_service_id				        integer,
	user_group_id					                integer 								not null,
	micro_service_id						        integer	 								not null,
	insert_date						                timestamp with time zone				default now(),
	constraint user_group_micro_service_pk 	        primary key (user_group_micro_service_id)
);

comment on table user_group_micro_service is '사용자 그룹별 Micro Service';
comment on column user_group_micro_service.user_group_micro_service_id is '고유번호';
comment on column user_group_micro_service.user_group_id is '사용자 그룹 고유키';
comment on column user_group_micro_service.micro_service_id is 'Micro Service 고유키';
comment on column user_group_micro_service.insert_date is '등록일';
