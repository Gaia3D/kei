...
create table policy(
	...
	content_menu_group_root					varchar(60)			default 'KEI',
	content_user_group_root					varchar(60)			default 'KEI',
	content_layer_group_root				varchar(60)			default 'KEI',
	content_data_group_root					varchar(60)			default 'KEI',
	content_design_layer_group_root			varchar(60)			default 'KEI',
	content_data_library_group_root			varchar(60)			default 'KEI',
	content_urban_group_root			    varchar(60)			default 'KEI',
