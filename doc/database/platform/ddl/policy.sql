...
create table policy(
	...
	content_menu_group_root					varchar(60)			default 'KEITI',
	content_user_group_root					varchar(60)			default 'KEITI',
	content_layer_group_root				varchar(60)			default 'KEITI',
	content_data_group_root					varchar(60)			default 'KEITI',
	content_design_layer_group_root			varchar(60)			default 'KEITI',
	content_data_library_group_root			varchar(60)			default 'KEITI',
	content_urban_group_root			    varchar(60)			default 'KEITI',
    content_district_available              boolean             default false,
...
comment on column policy.content_district_available is '행정구역 사용여부';
