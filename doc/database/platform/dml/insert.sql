...
values
	...
	('kei', 2, 'Gaia3D', '$2a$10$2mCd67fsbjmCukpaBlbcau7pjqGqqOeVG6HPiw/jUVWOs//CkcGsq', 'Y', now());
...
VALUES
    ...
    (4, 'd', '인천 계양 신도시', 'admin', 1, 1, 2, 4, 0, ST_GeomFromText('POINT(126.76387565549689 37.55697218043392)', 4326), 3000, 3, true, true),
